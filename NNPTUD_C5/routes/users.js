...
let { validate, validationCreateUser,validationSiginUp, validationLogin, validationChangePassword } = require('../utils/validator');
/* GET users listing. */
...
router.post('/',validationSiginUp, validationLogin, validationChangePassword,check_authentication,check_authorization(constants.ADMIN_PERMISSION),validationCreateUser,validate, async function (req, res, next) {
  try {
    let body = req.body
